...
colorPicker.addEventListener('change', () => {
    ...
    document.styleSheets[1].addRule('header a::after' ,`background-image: linear-gradient(90deg, #1F2937 0%, #${colorValue} 100%);`)
...
getBtn.addEventListener('click', () => {
    ...
    fetch(`https://www.thecolorapi.com/scheme?hex=${colorValue}&mode=${mode}&count=6`)
    .then(res => res.json())
    .then(data => {
